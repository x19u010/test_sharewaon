...
class __TwigTemplate_46791d1b441dae06089b159e369f78decfc70288c3f75a564718ec3ed061ac9a extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("+ Add constraint");
    ...
    ";
        ...
        if ( !(null === twig_get_attribute($this->env, $this->source, ($context["relation_parameters"] ?? null), "relationFeature", [], "any", false, false, false, 102))) {
            // line 103
            echo "        ";
            if (((0 !== twig_compare(($context["default_sliders_state"] ?? null), "disabled")) && PhpMyAdmin\Utils\ForeignKey::isSupported(($context["tbl_storage_engine"] ?? null)))) {
                // line 104
                echo "        <div class=\"mb-3\">
...
echo _gettext("Choose column to display:");
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                ...
                echo "\"";
                // line 213
                if (((isset($context["disp"]) || array_key_exists("disp", $context)) && (0 === twig_compare((($__internal_compile_14 = $context["row"]) && is_array($__internal_compile_14) || $__internal_compile_14 instanceof ArrayAccess ? ($__internal_compile_14["Field"] ?? null) : null), ($context["disp"] ?? null))))) {
                    // line 214
...
";
    ...
    {
        return new Source("", "table/relation/common_form.twig", "/home/ec2-user/blog/phpMyAdmin/templates/table/relation/common_form.twig");
    }
}
